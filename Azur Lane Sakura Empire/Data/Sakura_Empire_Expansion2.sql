...
VALUES	('GOVERNOR_AZUR_LANE_AKASHI',						'KIND_GOVERNOR'				),
		...
		('MODIFIER_AKASHI_TEAM_PLAYERS_ATTACH_MODIFIER',	'KIND_MODIFIER'				),
		('MODIFIER_AKASHI_ADJUST_BUILDING_PURCHASE_COST',	'KIND_MODIFIER'				);

INSERT INTO CivilizationTraits (CivilizationType, TraitType)
VALUES	('CIVILIZATION_AZUR_LANE_SE', 'TRAIT_CIVILIZATION_UNIT_BULIN_MK1_PLACEHOLDER'),
...
OR		TraitType = 'TRAIT_LEADER_SOLOMON_NIGHTMARE'
...
VALUES	('GOVERNOR_PROMOTION_SHOPKEEPER_KANBAN',	'SHOPKEEPER_KANBAN_GRANT_BULIN_MK1'		),
		...
		('GOVERNOR_PROMOTION_WISDOM_QUBE_STUDY',	'WISDOM_QUBE_STUDY_MILITARY_SLOT'		),
...
VALUES	('TRAIT_SHIGURE_YUKIKAZE_PREVENET_STRUCTURAL_DAMAGE',	'MODIFIER_PLAYER_CITIES_ATTACH_MODIFIER'		),
...
INSERT INTO Modifiers (ModifierId, ModifierType, SubjectRequirementSetId, SubjectStackLimit, RunOnce, Permanent)
VALUES	('SHOPKEEPER_KANBAN_GRANT_BULIN_MK1',	'MODIFIER_AKASHI_TEAM_PLAYERS_ATTACH_MODIFIER',	NULL, 1, 0, 1),
		('LOGISTICS_REPAIR_GRANT_BULIN_MK1',	'MODIFIER_AKASHI_TEAM_PLAYERS_ATTACH_MODIFIER', NULL, 1, 0, 1),
		('EQUIPMENT_SUPPLY_GRANT_BULIN_MK1',	'MODIFIER_AKASHI_TEAM_PLAYERS_ATTACH_MODIFIER', NULL, 1, 0, 1),
		('SHIPYARD_EXPANSION_GRANT_BULIN_MK1',	'MODIFIER_AKASHI_TEAM_PLAYERS_ATTACH_MODIFIER', NULL, 1, 0, 1),
		('PROJECT_RESEARCH_GRANT_BULIN_MK2',	'MODIFIER_AKASHI_TEAM_PLAYERS_ATTACH_MODIFIER', NULL, 1, 0, 1),
		('WISDOM_QUBE_STUDY_GRANT_BULIN_MK2',	'MODIFIER_AKASHI_TEAM_PLAYERS_ATTACH_MODIFIER', NULL, 1, 0, 1
),(
	'AKASHI_GRANT_BULIN_MK1',
	'MODIFIER_PLAYER_CITIES_GRANT_UNIT_IN_CITY',
	'CITY_HAS_GOVERNOR_PROMOTION_SHOPKEEPER_KANBAN',
	0, 1, 1
),(
	'AKASHI_GRANT_BULIN_MK2',
	'MODIFIER_PLAYER_CITIES_GRANT_UNIT_IN_CITY',
	'CITY_HAS_GOVERNOR_PROMOTION_SHOPKEEPER_KANBAN',
	0, 1, 1
),(
	'WISDOM_QUBE_STUDY_MILITARY_SLOT',
	'MODIFIER_AKASHI_TEAM_PLAYERS_ATTACH_MODIFIER',
	'PLAYER_IS_SAKURA_EMPIRE_LEADER',
	1, 0, 1
),(
	'SAKURA_EMPIRE_EXTRA_SLOT',
...
VALUES (
	...
	'MODIFIER_GOVERNOR_ADJUST_PREVENET_STRUCTURAL_DAMAGE'
		...
		('WISDOM_QUBE_STUDY_MILITARY_SLOT',				'ModifierId',			'SAKURA_EMPIRE_EXTRA_SLOT'	),
		('SAKURA_EMPIRE_EXTRA_SLOT',					'GovernmentSlotType',	'SLOT_MILITARY'				);
