...
VALUES	('TRAIT_CIVILIZATION_UNIT_BULIN',	'KIND_TRAIT'),
		('UNIT_BULIN_MK1',					'KIND_UNIT'	),
		('UNIT_BULIN_MK2',					'KIND_UNIT'	);

INSERT INTO Traits (TraitType, Name, Description)
VALUES	('TRAIT_CIVILIZATION_UNIT_BULIN', 'LOC_UNIT_BULIN_MK1_NAME', 'LOC_UNIT_BULIN_MK1_DESCRIPTION');
...
INSERT INTO Units(
	...
	/* Charge */ 3,
	/* Prereq */ NULL,
	/* Trait  */ 'TRAIT_CIVILIZATION_UNIT_BULIN'
),(
	/* Type   */ 'UNIT_BULIN_MK2',
