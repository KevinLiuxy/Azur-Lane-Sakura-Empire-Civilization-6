...
VALUES	('TRAIT_CIVILIZATION_BUILDING_KAIGUN_KOSHO',		'KAIGUN_KOSHO_NAVAL_UNIT_HEAL'			),
...
INSERT INTO Buildings(
	...
	'LOC_BUILDING_KAIGUN_KOSHO_NAME',
	'LOC_BUILDING_KAIGUN_KOSHO_DESCRIPTION',
	PrereqTech, PrereqDistrict, PurchaseYield, 1/*Cost*/, AdvisorType, Maintenance,
	2, 1, 2,
	'TRAIT_CIVILIZATION_BUILDING_KAIGUN_KOSHO'
FROM Buildings
...
INSERT INTO District_Adjacencies (DistrictType, YieldChangeId)
VALUES	('DISTRICT_CAMPUS',				'Sakura_Jinja_Campus_Science'		),
		('DISTRICT_COMMERCIAL_HUB',		'Sakura_Jinja_Commercial_Gold'		),
		('DISTRICT_HARBOR',				'Sakura_Jinja_Harbor_Gold'			),
		('DISTRICT_THEATER',			'Sakura_Jinja_Theater_Culture'		),
		('DISTRICT_INDUSTRIAL_ZONE',	'Sakura_Jinja_Industrial_Production');

INSERT INTO Adjacency_YieldChanges (ID, Description, YieldType, YieldChange, TilesRequired, AdjacentDistrict)
VALUES (
	'Sakura_Jinja_Campus_Science',
	'LOC_DISTRICT_SAKURA_JINJA_SCIENCE',
	'YIELD_SCIENCE', 1, 1,
	'DISTRICT_SAKURA_EMPIRE_JINJA'
),(
	'Sakura_Jinja_Commercial_Gold',
	'LOC_DISTRICT_SAKURA_JINJA_GOLD',
	'YIELD_GOLD', 1, 1,
	'DISTRICT_SAKURA_EMPIRE_JINJA'
),(
	'Sakura_Jinja_Harbor_Gold',
	'LOC_DISTRICT_SAKURA_JINJA_GOLD',
	'YIELD_GOLD', 1, 1,
	'DISTRICT_SAKURA_EMPIRE_JINJA'
),(
	'Sakura_Jinja_Theater_Culture',
	'LOC_DISTRICT_SAKURA_JINJA_CULTURE',
	'YIELD_CULTURE', 1, 1,
	'DISTRICT_SAKURA_EMPIRE_JINJA'
),(
	'Sakura_Jinja_Industrial_Production',
	'LOC_DISTRICT_SAKURA_JINJA_PRODUCTION',
...
VALUES	('KAIGUN_KOSHO_NAVAL_UNIT_HEAL',			'Amount',				15									),
...
VALUES	('UNIT_IS_ADJACENT_TO_KAIGUN_KOSHO',	'REQUIREMENTSET_TEST_ALL'),
...
VALUES	('UNIT_IS_ADJACENT_TO_KAIGUN_KOSHO',	'REQUIRES_PLOT_ADJACENT_TO_KAIGUN_KOSHO'		),
...
VALUES	('SAKURA_EMPIRE_UNIT_IS_NAVAL_REQUIREMENT',			'REQUIREMENT_UNIT_DOMAIN_MATCHES'					),
...
VALUES	('SAKURA_EMPIRE_UNIT_IS_NAVAL_REQUIREMENT',			'UnitDomain',	'DOMAIN_SEA'					),
