...
<AssetObjects..TextureInstance>
	...
	<m_SourceFilePath text="//civ6/main/Azur Lane Sakura Empire\Textures\INGAME_BACKGROUND_SAKURA_EMPIRE_2.dds"/>
	<m_SourceObjectName text=""/>
	<m_ImportedTime>0</m_ImportedTime>
	<m_ExportedTime>1140591950</m_ExportedTime>
	<m_ClassName text="UserInterface"/>
	<m_DataFiles>
		<Element>
			<m_ID text="DDS"/>
			<m_RelativePath text="INGAME_BACKGROUND_SAKURA_EMPIRE_2.dds"/>
		</Element>
	</m_DataFiles>
	<m_Name text="INGAME_BACKGROUND_SAKURA_EMPIRE_2"/>
	<m_Description text=""/>
	<m_Tags>
