...
<AssetObjects..TextureInstance>
	...
	<m_SourceFilePath text="//civ6/main/Azur Lane Sakura Empire\Textures\TEXTURE_LEADER_AL_AYANAMI.dds"/>
	<m_SourceObjectName text=""/>
	<m_ImportedTime>0</m_ImportedTime>
	<m_ExportedTime>1542905131</m_ExportedTime>
	<m_ClassName text="Leader_BaseColor"/>
	<m_DataFiles>
		<Element>
			<m_ID text="DDS"/>
			<m_RelativePath text="TEXTURE_LEADER_AL_AYANAMI.dds"/>
		</Element>
	</m_DataFiles>
	<m_Name text="TEXTURE_LEADER_AL_AYANAMI"/>
	<m_Description text=""/>
	<m_Tags/>
</AssetObjects..TextureInstance>
