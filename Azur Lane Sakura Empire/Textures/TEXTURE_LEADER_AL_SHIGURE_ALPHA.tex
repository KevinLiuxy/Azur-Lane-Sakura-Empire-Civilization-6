...
<AssetObjects..TextureInstance>
	...
	<m_SourceFilePath text="//civ6/main/Azur Lane Sakura Empire\Textures\TEXTURE_LEADER_AL_SHIGURE_ALPHA.dds"/>
	<m_SourceObjectName text=""/>
	<m_ImportedTime>0</m_ImportedTime>
	<m_ExportedTime>3407682387</m_ExportedTime>
	<m_ClassName text="Leader_OPAC"/>
	<m_DataFiles>
		<Element>
			<m_ID text="DDS"/>
			<m_RelativePath text="TEXTURE_LEADER_AL_SHIGURE_ALPHA.dds"/>
		</Element>
	</m_DataFiles>
	<m_Name text="TEXTURE_LEADER_AL_SHIGURE_ALPHA"/>
	<m_Description text=""/>
	<m_Tags/>
</AssetObjects..TextureInstance>
