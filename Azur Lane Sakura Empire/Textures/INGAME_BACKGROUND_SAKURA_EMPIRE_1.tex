...
<AssetObjects..TextureInstance>
	...
	<m_SourceFilePath text="//civ6/main/Azur Lane Sakura Empire\Textures\INGAME_BACKGROUND_SAKURA_EMPIRE_1.dds"/>
	<m_SourceObjectName text=""/>
	<m_ImportedTime>0</m_ImportedTime>
	<m_ExportedTime>1133293698</m_ExportedTime>
	<m_ClassName text="UserInterface"/>
	<m_DataFiles>
		<Element>
			<m_ID text="DDS"/>
			<m_RelativePath text="INGAME_BACKGROUND_SAKURA_EMPIRE_1.dds"/>
		</Element>
	</m_DataFiles>
	<m_Name text="INGAME_BACKGROUND_SAKURA_EMPIRE_1"/>
	<m_Description text=""/>
	<m_Tags>
