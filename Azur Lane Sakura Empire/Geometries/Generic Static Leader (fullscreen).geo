...
<Element>
<m_ID text="GR2"/>
<m_RelativePath text="Generic Static Leader (fullscreen).fgx"/>
</Element>
<Element>
<m_ID text="WIG"/>
<m_RelativePath text="Generic Static Leader (fullscreen).wig"/>
</Element>
</m_DataFiles>
<m_Name text="Generic Static Leader (fullscreen)"/>
<m_Description text="Generic Static Leader (fullscreen)"/>
<m_Tags>
<Element text="Leader"/>
</m_Tags>
<m_Groups/>
